    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection("subjectForm")
          // .doc(adminController.subjectIdController.text) // ❌ Ye line comment karen
              .doc(adminController.subjectList.first.id) // ✅ Ye line use karen
              .collection("enrollForm")
              .where("status", isEqualTo: "Approved")
              .snapshots(),
          builder: (context, snapshot) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if (approvedAt != null &&
                  ...
                  FirebaseFirestore.instance
                      .collection("subjectForm")
                      .doc(adminController.subjectList.first.id) // ✅ Yahan bhi change karen
                      .collection("enrollForm")
                      .doc(doc.id)
                      .update({"feesStatus": "notPaid"});
                  feesStatus = "notPaid";
